  ...
  return (
    <Formik
      ...
      onSubmit={async (values, { setStatus, resetForm }) => {
        setLoading(true)
        try {
          await authAxios.post('blogs', values)
          resetForm({})
          router.push('/')
        } catch (error) {
      ...
      validationSchema={Yup.object({
        ...
        text: Yup.string()
          ...
          .max(300000, 'Body cannot be longer than 30000 characters.'),
        tags: Yup.array()
      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          <div className={styles.container}>
            <FormInput
              label="Title of Blog"
              inputInfo="Be specific and imagine you’re reading a nice blog"
              type="text"
              name="title"
              autoComplete="off"
              value={values.title}
              ...
              placeholder="e.g The pitfalls of using BruteForce algorithm in many interview questions"
            />
            <Textarea
              label="Body"
              inputInfo="Write a nice and concise blog"
              name="text"
              autoComplete="off"
              value={values.text}
              onChange={handleChange}
              ...
              placeholder="The most naive approach ..."
            />
            <TagInput
              label="Tags"
              inputInfo="Add up to 5 tags to describe what your blog"
              type="text"
              name="tags"
              value={values.tags}
